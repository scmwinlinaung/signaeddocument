...
class ShareTransferEnactment extends StatefulWidget {
  const ShareTransferEnactment({Key? key}) : super(key: key);

  @override
  State<ShareTransferEnactment> createState() => _ShareTransferEnactmentState();
}

class _ShareTransferEnactmentState extends State<ShareTransferEnactment> {
        ...
        if (_pdf.isEmpty)
          FutureBuilder(
              ...
              future: PdfMutableDocument.readFile(
                  "asset/pdf/director-resolution.pdf"),
