...
class ShareSubscriptionForm extends StatefulWidget {
  @override
  State<ShareSubscriptionForm> createState() => _ShareSubscriptionFormState();
}

class _ShareSubscriptionFormState extends State<ShareSubscriptionForm> {
      ...
      children: [
        ...
        MaterialButton(
            ...
            onPressed: () async {
              ...
              var signedDocument =
                  await generateShareSubscriptionSignedDocument(
