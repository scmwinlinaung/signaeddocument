...
Future<Uint8List> generateShareSubscriptionSignedDocument(
    PdfPageFormat format, dynamic image, double price, double quantity) async {
  final doc = pw.Document(pageMode: PdfPageMode.outlines);

  final font1 = await PdfGoogleFonts.openSansRegular();
  final font2 = await PdfGoogleFonts.openSansBold();
  // final shape = await rootBundle.loadString('asset/document.svg');
  // final swirls = await rootBundle.loadString('asset/swirls2.svg');
  ...
  doc.addPage(pw.MultiPage(
      ...
      header: (pw.Context context) {
        ...
        return pw.Container(
            ...
            child: pw.Text('Share Subscription Agreement',
      ...
      build: (pw.Context context) => <pw.Widget>[
            pw.Header(
                ...
                child: pw.Row(
                    ...
                    children: <pw.Widget>[
                      pw.Text('Share Subscription Agreement',
                          textScaleFactor: 2),
                      pw.PdfLogo()
                    ])),
            pw.Paragraph(
            ...
            pw.Text('quantity ${quantity.toString()}',
                textScaleFactor: 2,
                style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),

            pw.Text('price ${price.toString()}',
                textScaleFactor: 2,
                style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
