...
Future<Uint8List> generateShareTransferSignedDocument(PdfPageFormat format,
    dynamic image, String name, String gmail, String phone) async {
  ...
  doc.addPage(pw.MultiPage(
      ...
      header: (pw.Context context) {
        ...
        return pw.Container(
            ...
            child: pw.Text('Share Transfer Agreement',
      ...
      build: (pw.Context context) => <pw.Widget>[
            pw.Header(
                ...
                child: pw.Row(
                    ...
                    children: <pw.Widget>[
                      pw.Text('Share Transfer Agreement', textScaleFactor: 2),
                      pw.PdfLogo()
                    ])),
            pw.Paragraph(
                text:
